...
<template>
  ...
  >
    <div @click="emit('closePopup')" class="c-clickable absolute top-1 left-1">
      <div
    ...
    <div @click="emit('closePopup')" class="c-clickable absolute top-1 right-1">
    ...
    <div class="c-popup-content p-4 pt-6 flex flex-col gap-4 overflow-auto">
      ...
      <div class="grid grid-flow-row auto-rows-auto gap-2">
        ...
        <div class="grid grid-cols-3 gap-8 text-center items-center">
          <input type="text" class="c-text-input" v-model="new_title" />
          <input type="text" class="c-text-input" v-model="new_content" />
          <div class="mx-auto">
            <img
              src="/icons/plus.svg"
              class="c-clickable h-6"
